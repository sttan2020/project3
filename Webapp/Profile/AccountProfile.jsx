...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentadvanceservicesprofile.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    updateAndSaveData(newValues) {
        ...
        let newData = Object.assign({}, this.state.profileData, newValues)
        this.saveProfile(newData)
        //this.setState({
        //    profileData: newProfile
        //}, this.saveProfile)
    }
    ...
    saveProfile(data) {
        ...
        $.ajax({
            url: 'https://talentadvanceservicesprofile.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='https://talentadvanceservicesprofile.azurewebsites.net/profile/profile/updateProfilePhoto'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'https://talentadvanceservicesprofile.azurewebsites.net/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'https://talentadvanceservicesprofile.azurewebsites.net/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                    </div>
                                </form>
